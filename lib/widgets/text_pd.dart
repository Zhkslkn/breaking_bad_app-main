...
class TextPD extends StatelessWidget {
  ...
  const TextPD({
    required this.label,
    required this.value,
    this.color = const Color(0xff0E5334),
    this.fontSize = 18,
    this.maxValuexLine = 16,
    this.maxValuexNextLine = 27,
  });
        ...
        child: Column(
          children: [
            ...
            Stack(children: [
              SizedBox(
                  width: idxFrom == 0.0
                      ? size.width - (label.length.toDouble() * 13)
                      : size.width - 20,
                  child: Text(value.substring(idxFrom, idxTo),
                      style: TextStyle(
              ...
              Positioned(
                  ...
                  child: Container(
                    width: idxFrom == 0.0
                        ? value.substring(idxFrom, idxTo).length * 15
                        : size.width - 20,
                    height: 2,
    ...
    return Column(
      children: [
        ...
        Column(
            ...
            children: (valueLines.length > 1)
                ? valueLines.getRange(1, valueLines.length).toList()
                : [Container()])
      ],
    );
  }
